...
with open('5.0550Hz_errors.json', newline='') as jsonfile:
    ...
    epochs=[i for i in range(50,600,50)]
    ...
    # plt.xlabel("Epochs")
    # plt.plot(epochs,high["256.0Hz"][1:],color=(255/255,0/255,0/255))
    # plt.plot(epochs,high["32.0Hz"][1:],color=(255/255,0/255,255/255))
    # plt.plot(epochs,high["15.0Hz"][1:],color=(255/255,255/255,0/255))
    # plt.plot(epochs,high["10.0Hz"][1:],color=(0/255,0/255,255/255))
    # plt.plot(epochs,high["5.0Hz"][1:],color=(0/255,255/255,0/255))
    ...
    # plt.ylabel("Error rate")
    # plt.xlabel("Epochs")
    # plt.plot(epochs,low["256.0Hz"][1:],color=(255/255,0/255,0/255))
    # plt.plot(epochs,low["32.0Hz"][1:],color=(255/255,0/255,255/255))
    # plt.plot(epochs,low["15.0Hz"][1:],color=(255/255,255/255,0/255))
    # plt.plot(epochs,low["10.0Hz"][1:],color=(0/255,0/255,255/255))
    # plt.plot(epochs,low["5.0Hz"][1:],color=(0/255,255/255,0/255))
    # plt.savefig("low.png")
    ...
    # plt.ylabel("Error rate")
    # plt.xlabel("Epochs")
    # plt.plot(epochs,run["256.0Hz"][1:],color=(255/255,100/255,100/255))
    # plt.plot(epochs,run["32.0Hz"][1:],color=(255/255,100/255,255/255))
    # plt.plot(epochs,run["15.0Hz"][1:],color=(255/255,255/255,0/255))
    # plt.plot(epochs,run["10.0Hz"][1:],color=(0/255,0/255,255/255))
    # plt.plot(epochs,run["5.0Hz"][1:],color=(0/255,255/255,0/255))
    # plt.savefig("run.png")
    ...
    plt.ylabel("Error rate")
    plt.xlabel("Epochs")
    plt.plot(epochs,walk["256.0Hz"][1:],color=(255/255,100/255,100/255))
    plt.plot(epochs,walk["32.0Hz"][1:],color=(255/255,100/255,255/255))
    plt.plot(epochs,walk["15.0Hz"][1:],color=(255/255,255/255,0/255))
    plt.plot(epochs,walk["10.0Hz"][1:],color=(0/255,0/255,255/255))
    plt.plot(epochs,walk["5.0Hz"][1:],color=(0/255,255/255,0/255))
